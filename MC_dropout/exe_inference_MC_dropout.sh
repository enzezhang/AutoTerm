...
for list in `ls ${work_root}/list/MC_dropout.txt `
do
	echo $list
	echo "python /home/staff/enze/Front_DL3/pytorch-deeplab-xception/inference_MC_dropout.py ${work_root} ${work_root}/para.ini $list --backbone drndropout --workers 0 --cuda --useBN --batchSize 1 --resume ${work_root}/$network"
	...
	#python -u /home/staff/enze/Front_DL3/pytorch-deeplab-xception/inference.py ${work_root} ${work_root}/para.ini $list --backbone drn --workers 0 --cuda --useBN --batchSize 1 --freeze-bn true --resume ${work_root}/$network
done
...
images=(`cat ${work_root}/list/MC_dropout.txt |awk -F '/' '{print $NF}'`)
i=0
