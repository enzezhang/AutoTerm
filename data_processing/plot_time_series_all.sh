...
cat $area_change_Landsat5 | awk '{print $3,$1,error_Landsat_plot}' error_Landsat_plot="$error_Landsat" |gmt psxy -J$J -R$R -Sc0.1i -W1p,black -Ey+p1p -K -O >> $PS

cat $area_change_Landsat7 | awk '{print $3,$1,error_Landsat_plot}' error_Landsat_plot="$error_Landsat" |gmt psxy -J$J -R$R -Sc0.1i -W1p,yellow -Ey+p1p -K -O >> $PS
...
cat $area_change_sentinel1a | awk '{print $3,$1,error_S1A_plot}' error_S1A_plot="$error_Landsat" |gmt psxy -J$J -R$R -Sc0.1i -W1p,blue -Ey+p1p  -K -O >> $PS
