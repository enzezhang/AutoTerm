...
do
    ...
    #echo "python /home/zez/test_deep_learning/u_net/Unet_pytorch-master_Dec5/calculate_area.py --input ${file[i]} --date $temp"
        ...
        #echo "python /home/zez/data2/calving_front_deep_learning/script/calculate_area.py --input ${file[i]} --reference $ref_path/${file[i]} --date $temp"
        python /home/zez/data2/calving_front_deep_learning/script/calculate_area_DOY.py --input ${file[i]} --reference $ref_path/${file[i]} --date $temp
